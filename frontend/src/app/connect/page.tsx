    ...
    <main className="flex min-h-screen items-center justify-center bg-background px-6">
      <div className="w-full max-w-md space-y-8">
        <div className="space-y-2 text-center">
          <Link href="/" className="inline-block text-xs font-medium uppercase tracking-[0.2em] text-muted hover:text-foreground transition-colors">
            ← zava
          </Link>
          ...
          <p className="text-sm text-muted">
            Connect your Stellar wallet to start saving privately.
          </p>
        </div>
