...
const PRIMARY_NAV: NavItem[] = [
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 20 20" fill="none" className={iconClass} aria-hidden>
        <path
          d="M3.5 10h13M13 6.5l3.5 3.5-3.5 3.5"
          stroke="currentColor"
          strokeWidth="1.6"
          strokeLinecap="round"
          strokeLinejoin="round"
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 20 20" fill="none" className={iconClass} aria-hidden>
        <path
          d="M4.5 15.5 15.5 4.5m0 0H7m8.5 0V13"
          stroke="currentColor"
          strokeWidth="1.6"
          strokeLinecap="round"
          strokeLinejoin="round"
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 20 20" fill="none" className={iconClass} aria-hidden>
        <path
          d="M10 16.5v-10m0 0-4 4m4-4 4 4"
          stroke="currentColor"
          strokeWidth="1.6"
          strokeLinecap="round"
          strokeLinejoin="round"
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 20 20" fill="none" className={iconClass} aria-hidden>
        <path
          d="M10 2.5 3.5 5.5v4c0 4 2.8 6.9 6.5 8 3.7-1.1 6.5-4 6.5-8v-4L10 2.5Z"
          stroke="currentColor"
          strokeWidth="1.6"
          strokeLinejoin="round"
        />
        <path
          d="m7.5 9.7 1.8 1.8 3.5-3.5"
          stroke="currentColor"
          strokeWidth="1.6"
          strokeLinecap="round"
          strokeLinejoin="round"
...
const SECONDARY_NAV: NavItem[] = [
  {
    ...
    icon: (
      <svg viewBox="0 0 20 20" fill="none" className={iconClass} aria-hidden>
        ...
        />
        <path
          d="M10 8v-.5M10 13v.5M12.5 10.5H13M7 10.5h.5"
          stroke="currentColor"
          strokeWidth="1.4"
          strokeLinecap="round"
        />
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 20 20" fill="none" className={iconClass} aria-hidden>
        <circle cx="10" cy="10" r="7" stroke="currentColor" strokeWidth="1.6" />
        <path
          d="M8.2 8.2c0-1 .8-1.8 1.8-1.8s1.8.8 1.8 1.8c0 1.6-1.8 1.4-1.8 3M10 13.4v.1"
          stroke="currentColor"
          strokeWidth="1.6"
          strokeLinecap="round"
        />
